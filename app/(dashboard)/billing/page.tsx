import { getSubscriptionsData, getSitesData, getManualAccessData, getActivityData, getUsageDaysData, computeProjectGains } from '@/lib/dashboard-data'
...
import { ProjectGainsBoard } from '@/components/project-gains-board'
...
export default async function BillingPage({ searchParams }: { searchParams: { site?: string; plan?: string } }) {
  ...
  const gains = computeProjectGains(subscriptions as any[], manualAccess as any[])

  return <div className="page-enter">
    <section><div className="section-heading"><div><h2>Gains by project</h2><p>Subscription MRR plus manual access revenue, combined per project.</p></div></div><ProjectGainsBoard rows={gains} /></section>
