...
export default async function Dashboard({ searchParams }: { searchParams: { site?: string; plan?: string } }) {
  ...
  return <div className="app-shell">
    ...
    <main><header className="topbar"><h1>Overview</h1><div className="actions"><button className="secondary">Refresh</button><button className="primary">Add project</button></div></header>
